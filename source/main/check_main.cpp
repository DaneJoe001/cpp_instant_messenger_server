...
void check_danejoe_log()
{
    ...
    log_config.path = "/mnt/e/personal_code/code_cpp_project/cpp_instant_messenger_server/log/";
    log_config.name = "TestLog";
    log_config.is_console_output = true;
    log_config.is_file_output = true;
    log_config.console_log_level = BaseLogger::LogLevel::TRACE;
    log_config.file_log_level = BaseLogger::LogLevel::TRACE;

    std::cout << "测试 DaneJoe 日志系统..." << std::endl;
